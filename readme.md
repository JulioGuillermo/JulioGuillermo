...
así como el desarrollo de aplicaciones para Android.
Actualmente, utilizo mis habilidades para crear aplicaciones
innovadoras y fáciles de usar.
También tengo un interés en el campo de la inteligencia artificial,
especialmente en el aprendizaje profundo basado en redes neuronales.

Mi experiencia como arquitecto de software y desarrollador
me proporciona una comprensión integral de todo el ciclo de
vida del desarrollo de software.
Soy una persona muy motivada y comprometida con el aprendizaje continuo
para mantenerme a la vanguardia de los avances tecnológicos.
Tengo un título en Ingeniería en Ciencias de la Computación de
la Universidad de Ciencias Informáticas de La Habana, graduado en 2023. -->
...
<!---->
<!-- <div align="center"> -->
<!--   <img src="https://github-readme-activity-graph.vercel.app/graph?username=JulioGuillermo&radius=16&theme=gruvbox&area=true&order=5&hide_border=true" height="300" alt="activity-graph graph"  /> -->
<!-- </div> -->
